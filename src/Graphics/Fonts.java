...
public class Fonts {
        ...
        void setFonts(PApplet p5){
            ...
            this.fonts[0] = p5.createFont("Data/CHINESETAKEWAY.ttf",midaTitol);
            this.fonts[1] = p5.createFont("Data/Japan wave.ttf",midaSubtitol);
            this.fonts[2] = p5.createFont("Data/Roboto-Black.ttf",midaParagraf);
